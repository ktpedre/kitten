 ...
 */
#ifndef USER_TASK_SIZE_MAX
#define USER_TASK_SIZE_MAX			USER_TASK_SIZE
#endif
...
{
	unsigned long limit = USER_TASK_SIZE_MAX;
...
#ifndef access_ok
#define access_ok(type, addr, size) likely(__access_ok(addr, size))
#endif
